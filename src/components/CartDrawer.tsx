...
export default function CartDrawer() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const whatsappUrl = `https://wa.me/919345177714?text=${message}`;
        ...
        {cart.length > 0 && (
          <div className="p-4 bg-white border-t border-gray-100">
            <button 
              ...
              className={`w-full py-3.5 rounded-xl font-bold text-[15px] flex items-center justify-center gap-2 transition-all shadow-sm ${
                isFormValid 
